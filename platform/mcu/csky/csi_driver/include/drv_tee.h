...
/**
\brief TEE Capabilities.
*/
typedef struct {
    uint32_t md5_support: 1;      ///< support md5
    uint32_t sha_support: 1;      ///< support sha
    uint32_t hmac_support: 1;     ///< support hmac
    uint32_t base64_support: 1;   ///< support base64
    uint32_t reserve1: 12;        ///< reserve for future use
    uint32_t des3_support: 1;     ///< support des3
    uint32_t aes_support: 1;      ///< support aes
    uint32_t rsa_support: 1;      ///< support rsa
    uint32_t reserve2: 13;        ///< reserve for future use
} tee_capabilities_t;

/**
  \brief       Get TEE capabilities.
  \return      \ref tee_capabilities_t
*/
tee_capabilities_t csi_tee_get_capabilities();
