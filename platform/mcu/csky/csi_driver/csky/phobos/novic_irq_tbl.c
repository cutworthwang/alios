...
void (*g_irqvector[])(void) = {
#ifdef CONFIG_GPIO
    GPIOA_IRQHandler, /* 0, default interrupt entry */
#else
...
#endif
#ifdef CONFIG_GPIO
    GPIOB_IRQHandler, /* 27, default interrupt entry */
#else
    ...
    NOVIC_IRQ_Default_Handler, /* 31, default interrupt entry */
};
