...
/// \param[in]     ret_flags     The value of the event after setting.
/// \return execution status code. \ref k_status_t
...
/// \param[in]     ret_flags     event flags before clearing.
/// \return execution status code. \ref k_status_t
...
/// \param[in]     ev_handle     event flags handle to operate.
/// \param[in]     ret_flags     The value of the current event.
/// \return execution status code. \ref k_status_t
...
/// \param[in]     actl_flags    The value of the event at the time either the bits being waited for became set, or the block time expired.
