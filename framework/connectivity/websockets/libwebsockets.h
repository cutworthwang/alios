...
#if !defined(LWS_WITH_ESP8266) && !defined(OPTEE_TA) && !defined(LWS_WITH_ESP32) &&!defined(LWS_WITH_AOS)
#include <poll.h>
#include <netdb.h>
...
#if !defined(LWS_WITH_ESP8266) && !defined(LWS_WITH_ESP32)  && !defined(LWS_WITH_AOS)
/**
